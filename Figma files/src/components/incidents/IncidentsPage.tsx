...
const rawIncidents = [
  ...
  },
  {
    ...
    description: 'Bus 9 lost air pressure on the return leg and the brakes locked up two blocks short of the yard. No students aboard. A road service call brought it in on a tow and the unit was tagged out of service pending a compressor inspection.',
    bus: 'Bus 9',
    route: 'N/A',
    driver: 'Robert Thompson',
    severity: 'High',
  ...
  },
  {
    ...
    description: 'The overhead door at the west end of the wash bay was found buckled at the bottom panel and will not seat. The bay stays usable but the door is being left open, so the bay cannot be secured overnight. Contractor quote requested.',
    bus: 'N/A',
    route: 'N/A',
    severity: 'Medium',
    status: 'Open',
  ...
  },
  {
    ...
    time: '15:05',
    subject: 'thirdParty',
    type: 'Third Party Injury',
    description: 'A parent waiting at the corner stepped into the path of the opening service door and caught her shoulder on the edge. She declined medical attention at the scene. The driver held the run until a supervisor arrived and took a statement.',
    bus: 'Bus 7',
    route: 'Jefferson Middle AM - Blue',
    driver: 'Maria Garcia',
    severity: 'Medium',
    ...
    location: 'bus-stop',
    witnessPresent: true,
    witnessNames: ['Maria Garcia'],
    tags: ['injury'],
    involvedParties: [
      { partyType: 'thirdParty', name: 'Parent at the stop', role: 'Injured', severity: 'Medium', description: 'Waiting parent who stepped into the swing of the service door as it opened.', actionTaken: 'Declined medical attention. Statement taken by the supervisor on scene.', notes: 'Asked to be contacted about the stop layout.' },
    ],
  },
];
