...
export function StudentsPage({ onNavigate, initialActiveIncidentsFilter = false, onNavigateToIncidentDetail }: StudentsPageProps) {
  ...
  const filteredStudents = mockStudents.filter((student) => {
    ...
    const hasActiveIncidents = incidentsFor(student).some((incident: any) => incident.status !== 'Resolved');
  ...
  const studentsWithActiveIncidents = mockStudents.filter(s => incidentsFor(s).some((i: any) => i.status !== 'Resolved')).length;
            ...
            <table className="forge-table">
              ...
              <tbody>
                {paginatedStudents.map((student) => {
                  const activeIncidents = incidentsFor(student).filter((incident: any) => incident.status !== 'Resolved');
