...
export const workflows: Workflow[] = [
  ...
  {
    id: 'WF-007',
    name: 'Employee Altercation Response',
    ownerRole: 'Administrator',
    description: 'Workflow for a physical or verbal altercation between two employees. Routed to the administrator rather than a school, with no parent notification and no student discipline.',
    incidentTypes: ['Employee Altercation'],
    isActive: true,
    createdBy: 'Sarah Williams',
  ...
  {
    id: 'WF-009',
    name: 'Location Damage Response',
    ownerRole: 'Administrator',
    description: 'Workflow for damage to a depot, garage, or yard. Routed to the administrator, with no student or parent involvement.',
    incidentTypes: ['Location Damage'],
    isActive: true,
    createdBy: 'Mike Chen',
    createdDate: '2026-08-11',
    lastModified: '2026-08-11',
    steps: [
      ...
      },
      {
        ...
        description: 'The administrator inspects the damage, records its extent, photographs it, and determines whether an outside contractor is needed.',
        assignedRole: 'Administrator',
  ...
  // ─────────────────────────────────────────────
  // VEHICLE
  // Routed to the fleet manager. Students can be aboard a collision, which is
  // why the three collision workflows carry a parent notification step.
  // ─────────────────────────────────────────────
  {
    id: 'WF-010',
    name: 'Vehicle Damage Response',
    ownerRole: 'Fleet Manager',
    description: 'Workflow for damage found on a vehicle where the cause may not be known. Routed to the fleet manager, with the mechanic performing inspection and repair.',
    incidentTypes: ['Vehicle Damage'],
    isActive: true,
    createdBy: 'Mike Chen',
    createdDate: '2026-08-11',
    lastModified: '2026-08-11',
    steps: [
      {
        id: 'step-1',
        name: 'Take Out of Service and Photograph',
        description: 'Remove the vehicle from service and photograph the damage from every angle that shows it.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '30 minutes',
        required: true,
        order: 1,
...

  {
    ...
    ownerRole: 'Fleet Manager',
    description: 'Workflow for a collision between two or more district vehicles. Two drivers to interview and two vehicles to assess, so it carries statement and preventability steps a single vehicle workflow has no need for.',
    incidentTypes: ['Multi Vehicle Collision'],
    isActive: true,
    createdBy: 'Mike Chen',
    ...
    steps: [
      {
        id: 'step-1',
        name: 'Secure the Scene and Confirm Nobody Is Injured',
        description: 'Check both vehicles for injuries, move them clear only if it is safe to do so, and report the contact to the fleet manager.',
        assignedRole: 'Driver',
        estimatedDuration: '30 minutes',
        required: true,
        order: 1,
      ...
      {
        id: 'step-2',
        name: 'Take Both Vehicles Out of Service and Photograph',
        description: 'Remove both vehicles from service and photograph the damage on each, including the point of contact from both sides.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '1 hour',
        required: true,
        order: 2,
      ...
      // Only runs when students were named on the incident. A collision
      // workflow is otherwise a fleet sequence, so with children aboard nobody
      // is assigned to call the families. The flag on each student records that
      // it happened; this step is what makes someone responsible for it.
      {
        id: 'step-3',
        name: 'Parent Notification',
        description: 'Contact the parent or guardian of every student named on the incident and record the notification against that student.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '1 hour',
        required: true,
        order: 3,
        ...
        trigger: {
          type: 'conditional',
          conditions: [{ field: 'studentsAboard', operator: 'greater-than', value: '0' }],
        },
        emailNotifications: {
          notifyOnStart: false,
          notifyOnComplete: true,
      ...
      {
        id: 'step-4',
        name: 'Collect a Statement from Each Driver',
        description: 'Take a separate written statement from every driver involved, recorded against that driver on the incident.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '1 business day',
        required: true,
        order: 4,
      ...
      {
        id: 'step-5',
        name: 'Damage Assessment and Estimate per Vehicle',
        description: 'Inspect each vehicle and produce a separate repair estimate, so cost is known per vehicle rather than as one figure.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '2 business days',
        required: true,
        order: 5,
      ...
      {
        id: 'step-6',
        name: 'Preventability Review',
        description: 'Review yard or site camera footage alongside both statements and record whether the collision was preventable and which vehicle was at fault.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '3 business days',
        required: true,
        order: 6,
      ...
      {
        id: 'step-7',
        name: 'Repair and Return Both Vehicles to Service',
        description: 'Complete the repairs, pass inspection on each vehicle, and return both to service.',
        assignedRole: 'Fleet Manager',
  ...
  {
    id: 'WF-011',
    name: 'Third Party Collision Response',
    ownerRole: 'Safety Coordinator',
    description: 'Workflow for a collision with a vehicle, cyclist, or pedestrian outside the district. Covers scene safety, information exchange, and the insurance claim.',
    incidentTypes: ['Third Party Collision'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-08-11',
    lastModified: '2026-08-11',
    steps: [
      {
        ...
        description: 'Secure the scene, check for injuries on both sides, and contact police or emergency services if required.',
        assignedRole: 'Driver',
        estimatedDuration: '20 minutes',
        required: true,
        order: 1,
      ...
      },
      {
        ...
        description: 'Exchange insurance and contact information with the other party, photograph the scene and both vehicles, and record the police report reference.',
        assignedRole: 'Driver',
        estimatedDuration: '30 minutes',
        required: true,
        order: 2,
      ...
      {
        id: 'step-4',
        name: 'Collect the Driver Statement',
        description: 'Take a written statement from the district driver, recorded against that driver on the incident.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '1 business day',
        required: true,
        order: 4,
  ...
  {
    id: 'WF-014',
    name: 'Employee Misconduct Review',
    ownerRole: 'Administrator',
    description: 'Workflow for a policy violation by a single employee, with no altercation involved. Routed to the administrator, with no parent notification and no student discipline.',
    incidentTypes: ['Employee Misconduct'],
    isActive: true,
    createdBy: 'Sarah Williams',
    ...
    steps: [
      {
        id: 'step-1',
        name: 'Record the Allegation',
        description: 'Record what was reported, who reported it, and when it happened, and take the employee off duty if the allegation warrants it.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '30 minutes',
        required: true,
        order: 1,
      ...
      },
      {
        id: 'step-2',
        name: 'Statement Collection',
        description: 'Collect a written account from the employee and from anyone who witnessed the conduct. Statements are kept with the incident record.',
        assignedRole: 'Administrator',
        estimatedDuration: '45 minutes',
        required: true,
        order: 2,
      ...
      },
      {
        id: 'step-3',
        name: 'Administrative Review',
        description: 'The administrator reviews the statements against district policy and decides on any corrective action.',
        assignedRole: 'Administrator',
        estimatedDuration: '3 business days',
        required: true,
        order: 3,
      ...
      },
      {
        id: 'step-4',
        name: 'Outcome and Return to Duty',
        description: 'Record the outcome, communicate it to the employee, and confirm return-to-duty status.',
        assignedRole: 'Administrator',
        estimatedDuration: '1 business day',
        required: true,
        order: 4,
  ...
  {
    id: 'WF-015',
    name: 'Employee Substance Violation Response',
    ownerRole: 'Administrator',
    description: 'Workflow for a suspected substance violation by an employee. Removal from duty and testing come before the administrative review.',
    incidentTypes: ['Employee Substance Violation'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Remove from Duty Immediately',
        description: 'Take the employee off duty, arrange transport so they do not drive themselves, and secure the vehicle or equipment they were operating.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '15 minutes',
        required: true,
        order: 1,
      ...
      },
      {
        id: 'step-2',
        name: 'Testing',
        description: 'Send the employee for testing under district policy and record the referral against the incident.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '4 hours',
        required: true,
        order: 2,
      ...
      },
      {
        id: 'step-3',
        name: 'Statement Collection',
        description: 'Collect a written account from the supervisor who observed the behavior and from any witnesses.',
        assignedRole: 'Administrator',
        estimatedDuration: '45 minutes',
        required: true,
        order: 3,
      ...
      },
      {
        id: 'step-4',
        name: 'Administrative Review',
        description: 'The administrator reviews the test result and the statements, determines whether policy was violated, and decides on any corrective action.',
        assignedRole: 'Administrator',
        estimatedDuration: '3 business days',
        required: true,
        order: 4,
      ...
      },
      {
        id: 'step-5',
        name: 'Outcome and Return to Duty',
        description: 'Record the outcome, communicate it to the employee, and confirm whether they return to duty.',
        assignedRole: 'Administrator',
        estimatedDuration: '1 business day',
        required: true,
        order: 5,
  ...
  },
  {
    ...
    ownerRole: 'Administrator',
    description: 'Workflow for a loss of power, water, or heat at a depot, garage, or yard. Covers making the site safe, reporting to the provider, and deciding whether operations continue.',
    incidentTypes: ['Utility Failure'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Confirm the Failure and Make Area Safe',
        description: 'Confirm what has failed and how much of the site it affects, and take any equipment that depends on it out of service.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '20 minutes',
        required: true,
        order: 1,
      ...
      {
        id: 'step-2',
        name: 'Notify the Provider',
        description: 'Report the failure to the utility or vendor and record the reference number and the estimated restoration time.',
        assignedRole: 'Administrator',
        estimatedDuration: '1 hour',
        required: true,
        order: 2,
      ...
      },
      {
        ...
        description: 'Decide whether operations continue on site, move elsewhere, or pause, and record the decision so dispatch can act on it.',
        assignedRole: 'Administrator',
        estimatedDuration: '2 hours',
        required: true,
        order: 3,
      ...
      },
      {
        ...
        description: 'Confirm service is back and return the affected area and equipment to service.',
        assignedRole: 'Administrator',
        estimatedDuration: '30 minutes',
        required: true,
        order: 4,
  ...
  {
    id: 'WF-017',
    name: 'Location Safety Hazard Response',
    ownerRole: 'Administrator',
    description: 'Workflow for a hazard at a depot, garage, or yard that has not yet caused harm, such as ice, exposed wiring, or a blocked exit. Covers isolating the hazard and preventing a repeat.',
    incidentTypes: ['Location Safety Hazard'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Isolate the Hazard',
        description: 'Cone off or block access to the hazard and take any equipment near it out of service.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '20 minutes',
        required: true,
        order: 1,
      ...
      },
      {
        ...
        description: 'Record what the hazard is, how it arose, and who is exposed to it, and rate how urgently it needs correcting.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '4 hours',
        required: true,
        order: 2,
      ...
      },
      {
        ...
        description: 'Correct or remove the hazard, in house or with a contractor, and record what was done.',
        assignedRole: 'Administrator',
        estimatedDuration: '1 business day',
        required: true,
        order: 3,
      ...
      {
        id: 'step-4',
        name: 'Verify and Prevent Recurrence',
        description: 'Confirm the hazard is gone and record any change to procedure or inspection that keeps it from coming back.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '1 business day',
        required: true,
        order: 4,
  ...
  {
    id: 'WF-018',
    name: 'Mechanical Failure Response',
    ownerRole: 'Fleet Manager',
    description: 'Workflow for a mechanical fault on a vehicle, with no damage to photograph. Covers recovery where the fault happened in service, diagnosis, and whether the same fault is likely elsewhere in the fleet.',
    incidentTypes: ['Mechanical Failure'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Take Out of Service and Record the Fault',
        description: 'Remove the vehicle from service and record the fault, including what the driver observed and where it happened.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '30 minutes',
        required: true,
        order: 1,
      ...
      {
        id: 'step-2',
        name: 'Recover the Vehicle',
        description: 'Arrange a tow or a driveable move back to the garage, and arrange a replacement vehicle if a run is affected.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '4 hours',
        required: true,
        order: 2,
      ...
      },
      {
        ...
        description: 'Diagnose the fault, record the cause, and produce a repair estimate.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '1 business day',
        required: true,
        order: 3,
      ...
      },
      {
        id: 'step-5',
        name: 'Fleet Check',
        description: 'Decide whether the same fault is likely on other vehicles of that type and schedule inspections where it is.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '2 business days',
        required: true,
        order: 5,
  ...
  {
    id: 'WF-019',
    name: 'Single Vehicle Collision Response',
    ownerRole: 'Fleet Manager',
    description: 'Workflow for a district vehicle striking a fixed object. One driver to interview and one vehicle to assess, with a preventability review on the driver.',
    incidentTypes: ['Single Vehicle Collision'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Secure the Scene and Confirm Nobody Is Injured',
        description: 'Check for injuries, move the vehicle clear only if it is safe to do so, and report the collision to the fleet manager.',
        assignedRole: 'Driver',
        estimatedDuration: '30 minutes',
        required: true,
        order: 1,
      ...
      },
      {
        id: 'step-2',
        name: 'Take Out of Service and Photograph',
        description: 'Remove the vehicle from service and photograph the damage and the object that was struck.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '1 hour',
        required: true,
        order: 2,
      ...
      },
      {
        id: 'step-4',
        name: 'Collect the Driver Statement',
        description: 'Take a written statement from the driver, recorded against that driver on the incident.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '1 business day',
        required: true,
        order: 4,
      ...
      {
        id: 'step-5',
        name: 'Damage Assessment and Estimate',
        description: 'Inspect the vehicle and produce a repair estimate.',
        assignedRole: 'Fleet Manager',
        estimatedDuration: '2 business days',
        required: true,
        order: 5,
      ...
      },
      {
        id: 'step-6',
        name: 'Preventability Review',
        description: 'Review yard or site camera footage alongside the statement and record whether the collision was preventable.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '3 business days',
        required: true,
        order: 6,
  ...
  {
    id: 'WF-020',
    name: 'Third Party Injury Response',
    ownerRole: 'Safety Coordinator',
    description: 'Workflow for an injury to someone outside the district, such as a pedestrian or cyclist, whether or not a collision occurred. Covers medical attention, witness details, and the insurance claim.',
    incidentTypes: ['Third Party Injury'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Scene Safety and Emergency Services',
        description: 'Secure the scene, get medical help to the injured person, and contact police or emergency services if required.',
        assignedRole: 'Driver',
        estimatedDuration: '20 minutes',
        required: true,
        order: 1,
      ...
      {
        id: 'step-2',
        name: 'Record the Injured Party and Witnesses',
        description: 'Record the name and contact information of the injured person, photograph the scene, and record any witnesses and the police report reference.',
        assignedRole: 'Driver',
        estimatedDuration: '30 minutes',
        required: true,
        order: 2,
      ...
      },
      {
        id: 'step-4',
        name: 'Safety Review',
        description: 'The safety coordinator reviews the statement and the documentation, determines whether the driver is cleared to continue, and records whether the injury was preventable.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '4 hours',
        required: true,
        order: 4,
  ...
  {
    id: 'WF-021',
    name: 'Third Party Conduct Response',
    ownerRole: 'Safety Coordinator',
    description: 'Workflow for threatening or abusive conduct toward a driver by someone outside the district. There is no claim to file, so it ends on a decision about the stop or the route.',
    incidentTypes: ['Third Party Conduct'],
    isActive: true,
    createdBy: 'Sarah Williams',
    createdDate: '2026-09-03',
    lastModified: '2026-09-03',
    steps: [
      {
        id: 'step-1',
        name: 'Scene Safety and Emergency Services',
        description: 'Move the vehicle and any students clear of the person involved, and contact police if there is a threat.',
        assignedRole: 'Driver',
        estimatedDuration: '20 minutes',
        required: true,
        order: 1,
      ...
      {
        id: 'step-2',
        name: 'Record the Account and Describe the Person',
        description: 'Record what happened, a description of the person, the location, and the police report reference if one was filed.',
        assignedRole: 'Driver',
        estimatedDuration: '30 minutes',
        required: true,
        order: 2,
      ...
      },
      {
        id: 'step-3',
        name: 'Safety Review',
        description: 'The safety coordinator reviews the account, confirms the driver is fit to continue, and arranges support where they are not.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '4 hours',
        required: true,
        order: 3,
      ...
      {
        id: 'step-4',
        name: 'Stop or Route Decision',
        description: 'Decide whether the stop, the route, or the timing changes to keep it from happening again, and record the decision.',
        assignedRole: 'Safety Coordinator',
        estimatedDuration: '2 business days',
        required: true,
        order: 4,
...
export function assignWorkflowToIncident(incidentType: string, _severity?: string): Workflow | null {
  // Normalise legacy type names to the current canonical 5
  const normType = LEGACY_TYPE_MAP[incidentType] ?? incidentType;

  // Every event has exactly one workflow, so the event alone selects it.
  // Severity is recorded on the incident and stays editable, and it no longer
  // takes any part in choosing the workflow.
